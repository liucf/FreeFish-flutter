...
mixin _$CategoryModel {
  ...
  List<SubCategoryModel> get sub_category => throw _privateConstructorUsedError;
...
abstract class $CategoryModelCopyWith<$Res> {
  ...
  @useResult
  $Res call({int id, String name, List<SubCategoryModel> sub_category});
}
...
class _$_CategoryModel implements _CategoryModel {
  const _$_CategoryModel(
      {required this.id,
      required this.name,
      required final List<SubCategoryModel> sub_category})
...
// ignore: non_constant_identifier_names
  final List<SubCategoryModel> _sub_category;
// ignore: non_constant_identifier_names
  @override
  List<SubCategoryModel> get sub_category {
    if (_sub_category is EqualUnmodifiableListView) return _sub_category;
    // ignore: implicit_dynamic_type
    return EqualUnmodifiableListView(_sub_category);
  }

  @override
  String toString() {
    return 'CategoryModel(id: $id, name: $name, sub_category: $sub_category)';
  }
    ...
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            ...
            const DeepCollectionEquality()
                .equals(other._sub_category, _sub_category));
  }

  @JsonKey(ignore: true)
  @override
  int get hashCode => Object.hash(runtimeType, id, name,
      const DeepCollectionEquality().hash(_sub_category));
...
abstract class _CategoryModel implements CategoryModel {
  const factory _CategoryModel(
      ...
      required final List<SubCategoryModel> sub_category}) = _$_CategoryModel;
